...
public class ConnectionFactory {
    ...
    public static Connection getConnection() throws SQLException {
    	...
    	String url = "jdbc:postgresql://project-1.c4vpl5hki72c.us-east-2.rds.amazonaws.com:5432/postgres?currentSchema=project-1";
    	//your postgres username (should just be postgres)
    	String username = "postgres";
    	//your postgres password (hopefully just "password")
    	String password = "roottoor"; //It had better be password
