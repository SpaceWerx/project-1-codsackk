...
//	List<Users> users = userService.getUserByRole(role);
//	
//	int[] ids = new int[users.size() +1];
//	ids[users.size()] = 0;
//	for (int i = 0; i < users.size(); i++) 
//	{
//		ids[i] = users.get(i).getUserById();
//	}
//
//	
//	System.out.println("-------------------------------------------------------");
...
//	
//	for (Users u: users) {
//		System.out.println(u.getUserById() + " -> " + u.getUsername());
//	}
...
//	reimbursementToBeSubmitted.setAuthor(Employee.getUserById());
//	
//	System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
...
//		System.out.println(r.getReimbursementsId());
...
//			System.out.println(r.getReimbursementsId() + "->" + author.getUsername() + " : $" + r.getAmount());
//			ids[i] = r.getReimbursementsId();
//		}
//		
...
//		System.out.println("Processing reimbursement #" + reimbursementToBeProcessed.getReimbursementsId());
...
//	   if (as.login(username, password)!= 0) {
//		   accountFound = true;
//		   displayMenu();
//		   break;
//	   }else{
